export const DEFAULT_CONTENT = {
  ...
  redesigns: {
    ...
    items: [
      ...
      {
        slug: 'strother',
        name: 'Strother, Moreno & Fayollat, CPAs',
        category: 'Tax & Accounting · Pleasanton',
        blurb: 'A legacy CPA firm\'s dated site rebuilt into a polished, editorial presence that signals trust and decades of expertise.',
        thumbnail: '',
        summary: 'Bringing a 40-year boutique CPA firm online with a site as polished and personal as their client relationships.',
        previewUrl: '',
        previewNote: 'This preview is private. Contact me for the access password.',
        overviewHeading: 'Overview',
        overviewBody: 'Strother, Moreno & Fayollat has served Pleasanton and the Tri-Valley for nearly 40 years and 550+ clients — but their old "We\'ve Moved" site didn\'t show it. The redesign gives the firm an editorial, trustworthy presence built around its boutique, relationship-first approach.',
        challengeHeading: '',
        challengeBody: '',
        changesHeading: 'What I changed',
        changes: [
          'An editorial, ledger-inspired design with a serif type system that reads as established and trustworthy',
          'A "fact card" hero that surfaces the firm\'s credibility at a glance — 40 years, 550+ clients, boutique approach',
          'A bento-style services grid: tax planning, entity structuring, trust & estate, real-estate strategy and more',
          'A multi-page resource hub — tax tools, tax alerts/news, and directions with an embedded map',
          'A dashboard so the firm can edit copy, team, and alerts themselves — no developer needed',
        ],
        beforeImage: '/redesigns/strother/before.png',
        afterImage: '/redesigns/strother/after.png',
        gallery: [
          '/redesigns/strother/section-1.png',
          '/redesigns/strother/section-2.png',
        ],
      },
      {
        slug: 'water-quality-plumbing',
        name: 'Water Quality Plumbing',
        category: 'Plumbing & Water Treatment · Since 1970',
        blurb: 'A 50-year, third-generation plumber\'s old site reimagined with a bold, modern look and clear paths to a quote.',
        thumbnail: '',
        summary: 'Giving a third-generation South Bay plumber a bold, modern site that matches 50+ years of reputation.',
        previewUrl: '',
        previewNote: 'This preview is private. Contact me for the access password.',
        overviewHeading: 'Overview',
        overviewBody: 'Water Quality Plumbing has served the Santa Clara Valley since 1970 as a third-generation family business. The redesign trades a dated template for a bold, industrial look that puts their copper-repipe expertise and 50+ years front and center.',
        challengeHeading: '',
        challengeBody: '',
        changesHeading: 'What I changed',
        changes: [
          'A bold, industrial redesign (black + yellow) that feels modern and trustworthy on any screen',
          'A split hero with a free-estimate form and a one-tap call button for urgent jobs',
          'A clear, numbered service list — video inspection, water heaters, softeners, purification, sewer, gas and more',
          'A heritage section that leans into the story: established 1970, third generation, 50+ years',
          'A dashboard so the owner can edit services, team, and reviews without touching code',
        ],
        beforeImage: '/redesigns/water-quality-plumbing/before.png',
        afterImage: '/redesigns/water-quality-plumbing/after.png',
        gallery: [
          '/redesigns/water-quality-plumbing/section-1.png',
          '/redesigns/water-quality-plumbing/section-2.png',
        ],
      },
    ],
  },
