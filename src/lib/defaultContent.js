    ...
    tiers: [
      {
        ...
        price: '$1,500',
        billing: 'one-time',
        description: 'Perfect for solo operators or new businesses who need to look credible online — fast.',
        features: [
          'Up to 5 pages',
      ...
      },
      {
        ...
        price: '$3,500',
        billing: 'one-time',
        description: 'Everything in Starter, plus the self-serve admin panel so you can edit your site anytime.',
        features: [
          'Up to 10 pages',
          'Self-serve admin panel (Supabase)',
          'Image uploads + content history',
      ...
      },
      {
        ...
        description: 'Custom features and integrations — e-commerce, bookings, dashboards, whatever you need.',
        features: [
